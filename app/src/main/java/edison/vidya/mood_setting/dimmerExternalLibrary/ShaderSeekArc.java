package edison.vidya.mood_setting.dimmerExternalLibrary;
...
import edison.vidya.mood_setting.R;
...
public class ShaderSeekArc extends View {
    ...
    ImageView i;
    private float mStartValue = 1;
    private float mEndValue = 10;
    private float mProgress = 2;

    private float mStartAngle = -170;
    private float mEndAngle = 3;
  ...
  //  private Paint mLinePaint;
    ...
    private static final int sArcTotalWidth = 300;

    private SweepGradient mSweepGradient;

    private int mStartColor = 0xFFFF2D0C;
    private int mEndColor = 0xFF1636FF;
    ...
    private int mMarkColor = 0xFFFFFF;
